...
This includes arrangement of the notes, theme, date/time formats and more.
...
### Default List-Note View Mode

Choose which view mode list notes are initially opened with.
Can either be read or write mode or the last view mode that was used inside the note.
...
### Auto remove deleted Notes

You can set after how many days Notes in the `Deleted` Folder are automatically removed permanently.
